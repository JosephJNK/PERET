...
},{"./checkSolution.coffee":2,"./generateJsRegex.coffee":3,"./parseExtPosixRegex.coffee":4,"./extPosixToJs.coffee":5,"./stepifyProblem.coffee":6}],3:[function(require,module,exports){
(function() {
...
(function() {
  ...
  module.exports = function(testValues, solutionAttempt, actualSolution) {
    var didInclude, error, falseHits, hits, item, jsActualSolution, jsSolutionAttempt, misses, shouldInclude, _i, _len, _ref, _ref1;
    ...
    falseHits = [];
    misses = [];
    for (_i = 0, _len = testValues.length; _i < _len; _i++) {
      item = testValues[_i];
...
},{"./extPosixToJs.coffee":5}],5:[function(require,module,exports){
(function() {
  var generate, parse;
  ...
  module.exports = function(inputString) {
    var error, intermediateForm, resultantForm, _ref;
...
},{"./parseExtPosixRegex.coffee":4,"./generateJsRegex.coffee":3}],4:[function(require,module,exports){
(function() {
